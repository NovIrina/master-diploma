\makeatletter
  ...
  \newcommand{\ourmethodshortconv}{\textit{ID-LoRA (Conv)}}
  \newcommand{\ourmethodsFull}{\textit{Importance-driven LoRA}}
  ...
  \newcommand{\magnitude}{\textit{Magnitude}}
  \newcommand{\wanda}{\textit{Wanda}}
