...
Table \ref{tab:quality_1} shows the results of computational experiments conducted using the selected models and methods. The performance of the \dora{} approach with the \qwenLarge{} model is not reported because its memory demands exceeded the capabilities of the available hardware.
